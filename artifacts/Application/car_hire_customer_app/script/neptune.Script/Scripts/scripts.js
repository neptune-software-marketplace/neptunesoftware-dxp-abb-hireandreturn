...
sap.ui.core.Core().attachInit(function (data) {
    //Preselect city
...
function getRandomBookingNumber() {
  const randomNum = Math.floor(Math.random() * 900000) + 100000; // Generates a random 6-digit number
  return `BK${randomNum}`;
}